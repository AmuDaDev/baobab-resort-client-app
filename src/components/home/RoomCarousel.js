...
const RoomCarousel = () => {
	...
	return (
		<section className="bg-light mb-5 mt-5 shadow">
			<Link to={"/RoomListing"} className="hote-color text-center">
				Browse all rooms
			</Link>
									...
									<Col key={room.id} className="mb-4" xs={12} md={6} lg={3}>
										<Card>
											...
											<Card.Body>
												...
												<Card.Title className="room-price">R{room.roomPrice}/night</Card.Title>
												<div className="flex-shrink-0">
													<Link to={`/BookRoom/${room.id}`} className="btn btn-hotel btn-sm">Book Now</Link>
												</div>
											</Card.Body>
										</Card>
									</Col>
